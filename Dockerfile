...
ENV DUCOR_QTUM_ORACLE_PRIVATEKEY=
...
ENV DUCOR_ETH_RETHINKTABLE=eth_requests

ENV DUCOR_QTUM_RETHINKTABLE=qtum_requests
ENV DUCOR_QTUM_MASTER_ADDRESS=1ef399191357c0053884fadd0342c95da231bd95
ENV DUCOR_QTUM_PROVIDER=localhost:3889
ENV DUCOR_QTUM_ORACLE_ACCOUNT=root
